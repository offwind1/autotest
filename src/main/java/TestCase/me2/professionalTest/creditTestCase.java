...
public class creditTestCase {
    ...
    private Me2Teacher no_credit_teacher;
    ...
    public void beforeClass() {
        no_credit_teacher = GlobalMe2.init().getRandomTeacher();
    ...
    public void test_7_3() {
        JSONObject object = no_credit_teacher.getWeb().creditAgent().editCreditInfo(creditId, GlobalMe2.getImageUrl(), Common.creatRandomString());
    ...
    public void test_7_5() {
        JSONObject object = no_credit_teacher.getWeb().creditAgent().editCreditInfo("999", GlobalMe2.getImageUrl(), Common.creatRandomString());
        SampleAssert.assertMsg("修改失败", object);
    }
