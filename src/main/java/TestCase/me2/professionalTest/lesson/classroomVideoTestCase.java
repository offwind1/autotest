...
public class classroomVideoTestCase {
    ...
    public void assertGetVideoListClass(JSONObject object, Me2UserBase student, int classRoomCount) {
    ...
    public void assertGetVideoLesTypeClass(JSONObject object, Me2UserBase student, int classRoomCount) {
        JSONObject userInfo = Common.filder(object.getJSONArray("data"), student.getUserId(), "userId");
        if (ObjectUtil.isNull(userInfo)) {
