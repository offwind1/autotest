...
public class User {
    protected static AuthInterface service = Requests.getService(AuthInterface.class);
    protected static UserInterface userInterface = Requests.getService(UserInterface.class);
    protected String token;
    protected String project;


    public User(String project, String account, String password) {
    ...
    public JSONObject login(String account, String password) {
        JSONObject object = Requests.getJson(service.login(this.project, account, password));
    ...
    public JSONObject getPermissionInfo() {
        JSONObject object = Requests.getJson(service.getPermissionInfo(token));
        return object;
    }
    ...
    public JSONObject updateUserInfo(String userId, UserModel userModel) {
