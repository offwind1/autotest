...
public class MODLessonInfo extends MODBase<MODLessonInfo> {
     ...
     * 课程详情
     *
     * @param javaBean lessonInfo
     * @return
     */
    public JSONObject lessonInfo(PLJavaBean javaBean) {
        return exec("lessonInfo", javaBean);
    }
     ...
     * 查询用户课程列表
     *
     * @param javaBean usrLesson
     * @return
     */
    public JSONObject usrLesson(PLJavaBean javaBean) {
        return exec("usrLesson", javaBean);
    }
