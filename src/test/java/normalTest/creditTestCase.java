...
public class creditTestCase {
    ...
    public void beforeClass() {
        ...
        student = Global.init().getUser();
    }

    @Test(description = "添加学分信息web/credit/addCreditInfo")
    public void test_credit_addCreditInfo() {
        JSONObject object = teacher.getWeb().creditAgent().addCreditInfo("喵喵", Global.getImageUrl());
    ...
    public void test_credit_editCreditInfo() {
        JSONObject object = teacher.getWeb().creditAgent().editCreditInfo(creditId, Global.getImageUrl(), "喵币");
        SampleAssert.assertCode200(object);
    }
